                    ...
                    <nav class="flex justify-between items-center py-4">
                        ...
                        <div class="hidden md:flex items-center gap-6">
                            <div class="flex gap-6">
                                <button onclick="closeAndGoToSection('#about')" class="font-medium hover:text-accent transition-colors text-gray-700">
                                    ${language === 'es' ? 'Sobre Mí' : 'About Me'}
                                </button>
                                <button onclick="closeAndGoToSection('#projects')" class="font-medium hover:text-accent transition-colors text-gray-700">
                                    ${language === 'es' ? 'Proyectos' : 'Projects'}
                                </button>
                                <button onclick="closeAndGoToSection('#writing')" class="font-medium hover:text-accent transition-colors text-gray-700">
                                    ${language === 'es' ? 'Escritos' : 'Writing'}
                                </button>
                                <button onclick="closeAndGoToSection('#contact')" class="font-medium hover:text-accent transition-colors text-gray-700">
                            ...
                            <div class="flex items-center gap-2 border border-gray-200 rounded-full p-1">
                                <button onclick="switchLanguageAndClose('es')" class="${language === 'es' ? 'bg-accent text-white' : 'hover:bg-gray-100'} px-3 py-1 rounded-full transition-colors duration-300 text-sm font-medium">
                                    ES
                                </button>
                                <button onclick="switchLanguageAndClose('en')" class="${language === 'en' ? 'bg-accent text-white' : 'hover:bg-gray-100'} px-3 py-1 rounded-full transition-colors duration-300 text-sm font-medium">
                                    EN
                                </button>
                            </div>
...
function closeAndGoToSection(targetId) {
...
function switchLanguageAndClose(newLanguage) {
    ...
    // Cerrar la página completa para mostrar el contenido actualizado
    const fullPage = document.querySelector('.fixed.inset-0.bg-white.z-50');
    if (fullPage) {
        fullPage.remove();
    }
    
    // Actualizar los botones de idioma en la página principal
    setTimeout(() => {
